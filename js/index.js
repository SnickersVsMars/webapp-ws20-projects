...
$.ajax({
    ...
    success: function (items){
        $(items.projects).each(function(i, project){
            ...
            card.querySelector(".project-number").innerHTML = validate(project.number);
            card.querySelector(".project-manager").innerHTML = validate(project.manager);

            card.querySelector(".project-label").innerHTML = validate(project.label);
