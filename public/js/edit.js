...
document.getElementById('getme').innerText = 'hi ';

/*function populateData(project) {
    document.getElementById('label').placeholder = 'testtesttest';
    document.getElementById('number').placeholder = validate(project.number);

    setDescription(document.getElementById('description'), project.description);

    document.getElementById('manager').placeholder = validate(project.manager);
    document.getElementById('customer').placeholder = validate(project.customer);
    document.getElementById('costCenter').placeholder = validate(
        project.costCenter
    );
    document.getElementById(
        'breadcrumb'
    ).placeholder = `PROJEKT ${project.number}`;
    document
